    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-16">
        ...
        <div className="space-y-10">
          {/* Wing 1: Foundational */}
          <div className="bg-white p-8 rounded-2xl shadow-xs border border-slate-200 grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
        ...
        <div className="bg-linear-to-b from-[#0F2942] to-[#1E3A8A] text-white p-8 sm:p-12 rounded-3xl space-y-6">
